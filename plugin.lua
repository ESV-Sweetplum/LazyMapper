    ...
    if imgui.BeginTabItem("Basic") then
        ...
        if imgui.Button("Place Notes At Current Time") then
            ...
            elseif vars.randomPlacement == 1 then
                notes = generateSemiRandomNotes(vars.keyMode, vars.beatSnap, vars.patternLength, vars.rows, vars.notesInRow)
            else
                notes = generateBetterRandomNotes(vars.keyMode, vars.beatSnap, vars.patternLength, vars.rows, vars.notesInRow)
            end
